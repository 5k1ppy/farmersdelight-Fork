...
public enum ItemsRegistry {
    ...
    UNCOOKED_POTATO_CHIPS("uncooked_potato_chips", () -> new Item(food(Foods.UNCOOKED_POTATO_CHIPS))),
    POTATO_CHIPS("potato_chips", () -> new Item(food(Foods.POTATO_CHIPS))),
    PACKAGED_POTATO_CHIPS("packaged_potato_chips", () -> new Item(food(Foods.PACKAGED_POTATO_CHIPS))),
